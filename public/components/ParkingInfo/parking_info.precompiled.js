...
templates['parking_info'] = template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "    <div class=\"parking-info\">\n        <h3 class=\"parking-info__address\">"
    ...
    + "</p>\n"
    + ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"favourite") : depth0),{"name":"if","hash":{},"fn":container.program(2, data, 0),"inverse":container.program(4, data, 0),"data":data,"loc":{"start":{"line":5,"column":8},"end":{"line":12,"column":15}}})) != null ? stack1 : "")
    + "    </div>\n";
  ...
  return "            <div class=\"button-container\">\n                <button class=\"secondary-button\" id=\"show-on-map_button_"
    + container.escapeExpression(container.lambda(((stack1 = (depth0 != null ? lookupProperty(depth0,"parking") : depth0)) != null ? lookupProperty(stack1,"id") : stack1), depth0))
    + "\">На карте</button>\n                <button class=\"outline-button\" id=\"add-parking_button\">Добавить</button>\n            </div>\n";
  ...
  return ((stack1 = lookupProperty(helpers,"if").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"parking") : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":1,"column":0},"end":{"line":14,"column":7}}})) != null ? stack1 : "");
},"useData":true});
})();
